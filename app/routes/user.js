...
module.exports.setRouter = (app) => {
     ...
     * @apiParam {string} isAdmin true,if user is an admin, else false. (body params) (optional)
     * @apiParam {string} adminPasscode admin passcode, if isAdmin is true  (body params) (optional)
     *
    ...
    */
     ...
     * @apiGroup users
     * @apiVersion  1.0.0
     * @api {post} /api/v1/users/users/all to get all user details
     *
     *
     * @apiSuccess {object} myResponse shows error status, message, http status code, result.
     * 
    ...
    */
    ...
    app.get(`${baseUrl}/all/:authToken`, auth.isAuthorized, auth.isAdmin, userController.getAllUsers);
